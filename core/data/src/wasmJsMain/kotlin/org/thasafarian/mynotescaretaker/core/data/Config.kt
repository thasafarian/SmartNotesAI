...
/**
 * WebAssembly JavaScript implementation of Config.
...
actual object Config {
    private fun getEnv(key: String, defaultValue: String): String {
        // In Wasm, environment variables are injected at build time
        // For now, we'll use defaults. In production, use build config to inject env vars
        return defaultValue
    }
